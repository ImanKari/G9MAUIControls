...
public class G9ObservableRangeCollection<T> : ObservableCollection<T>
{
    /// <summary>
    ///     Initializes a new instance of the System.Collections.ObjectModel.ObservableCollection(Of T) class.
    /// </summary>
    public G9ObservableRangeCollection()
    {
    }
    ...
    public G9ObservableRangeCollection(IEnumerable<T> collection)
        : base(collection)
    {
    }
        ...
        NotifyCollectionChangedAction notificationMode = NotifyCollectionChangedAction.Add)
    {
        ...
        var result = collection as T[] ?? collection.ToArray();
        var itemsAdded = AddArrangeCore(result);
        ...
        var changedItems = collection is List<T> ts ? ts : [..result];
